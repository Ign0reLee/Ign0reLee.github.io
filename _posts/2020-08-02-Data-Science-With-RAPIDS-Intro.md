...
---
  ...
  <amp-img src="{{ site.baseurl }}assets/RAPIDS/intro/RAPIDS_all.jpg" width="100%" height="100%" layout="responsive" alt="" class="mb3"></amp-img>
  ...
  <amp-img src="{{ site.baseurl }}assets/RAPIDS/intro/RAPIDS_all_now.png" width="100%" height="100%" layout="responsive" alt="" class="mb3"></amp-img>
  <br><br>
