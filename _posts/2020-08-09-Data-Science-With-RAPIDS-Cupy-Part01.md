...
---
  ...
  !nvidia-smi
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/CPUTest.png" width="656" height="400" layout="responsive" alt="" class="mb3">
  <br><br>
  ...
  !nvidia-smi
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/GPUTest.png" width="656" height="400" layout="responsive" alt="" class="mb3">
...
---
  **numpy**
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/case1_cpu.png" width="656" height="50" layout="responsive" alt="" class="mb3">
  <br>
  **cupy**
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/case1_gpu.png" width="656" height="50" layout="responsive" alt="" class="mb3">
  <br><br>
...
---
  **numpy**
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/case2_cpu.png" width="656" height="50" layout="responsive" alt="" class="mb3">
  <br>
  **cupy**
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/case2_gpu.png" width="656" height="50" layout="responsive" alt="" class="mb3">
  <br><br>
...
---
  **numpy**
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/case3_cpu.png" width="656" height="50" layout="responsive" alt="" class="mb3">
  <br>
  **cupy**
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/case3_gpu.png" width="656" height="50" layout="responsive" alt="" class="mb3">
  <br>
...
---
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/ndarray.png" width="150" height="25" layout="responsive" alt="" class="mb3">
  <br>
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/cudarray.png" width="150" height="25" layout="responsive" alt="" class="mb3">
...
---
  ...
  ```
  <img src="./assets/img/images/RAPIDS/Cupy-01/cuda_to_ndarray.png" width="150" height="25" layout="responsive" alt="" class="mb3">
