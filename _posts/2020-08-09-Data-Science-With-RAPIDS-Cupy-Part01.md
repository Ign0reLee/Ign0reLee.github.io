...
---
  ...
  !nvidia-smi
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/CPUTest.png" width="656" height="400" layout="responsive" alt="" class="mb3"></amp-img>
  <br><br>
  ...
  !nvidia-smi
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/GPUTest.png" width="656" height="400" layout="responsive" alt="" class="mb3"></amp-img>
...
---
  **numpy**
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/case1_cpu.png" width="656" height="50" layout="responsive" alt="" class="mb3"></amp-img>
  <br>
  **cupy**
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/case1_gpu.png" width="656" height="50" layout="responsive" alt="" class="mb3"></amp-img>
  <br><br>
...
---
  **numpy**
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/case2_cpu.png" width="656" height="50" layout="responsive" alt="" class="mb3"></amp-img>
  <br>
  **cupy**
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/case2_gpu.png" width="656" height="50" layout="responsive" alt="" class="mb3"></amp-img>
  <br><br>
...
---
  **numpy**
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/case3_cpu.png" width="656" height="50" layout="responsive" alt="" class="mb3"></amp-img>
  <br>
  **cupy**
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/case3_gpu.png" width="656" height="50" layout="responsive" alt="" class="mb3"></amp-img>
  <br>
...
---
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/ndarray.png" width="150" height="25" layout="responsive" alt="" class="mb3"></amp-img>
  <br>
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/cudarray.png" width="150" height="25" layout="responsive" alt="" class="mb3"></amp-img>
...
---
  ...
  ```
  <amp-img src="{{ site.baseurl }}/assets/img/images/RAPIDS/Cupy-01/cuda_to_ndarray.png" width="150" height="25" layout="responsive" alt="" class="mb3"></amp-img>
